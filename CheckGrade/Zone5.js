...
// --- ZONE 5 SPECIFIC CHECKLIST DATA (24 Checkpoints) ---
const ZONE_5_CHECKLIST = [
  { id: 'z5_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_3', title: 'Facilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_4', title: 'Floors & Gangways', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_5', title: 'Employee Essentials', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_6', title: 'Tooling, Fixtures, Jigs', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_7', title: 'Wires, cabling & Hoses', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_8', title: 'Super Market 2 (Ready for Laying)', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_9', title: 'Workbenches & surfaces', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_10', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_11', title: 'Red Tag', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_12', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_13', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_14', title: 'Machine Guards, Windows & Interlocks', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_15', title: 'Cupboards & Racks', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_16', title: 'Hard patterns', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_17', title: 'Super Market 3 (Ready for Sewing)', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_18', title: 'Tab', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_19', title: 'Fusing Machine', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_20', title: 'Embroidery Section', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_21', title: 'Interlining Spreading & Die Cutting Zone', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_22', title: 'Interlining Storage Zone', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z5_23', title: 'Idle Machines', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone5({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 5</Text>
        <Text style={styles.auditHeaderBadge}>CUTTING</Text>
      </View>
