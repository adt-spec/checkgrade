...
// --- ZONE 33 SPECIFIC CHECKLIST DATA (9 Checkpoints) ---
const ZONE_33_CHECKLIST = [
  { id: 'z33_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z33_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z33_3', title: 'Kitchen & Equipment Zone', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z33_4', title: 'Hygiene & Food Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z33_5', title: 'Seating & Dining Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z33_6', title: 'Handwash & Sanitization', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z33_7', title: 'Dishwasher & Utensil Cleaning', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z33_8', title: 'Waste Disposal Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z33_9', title: 'Cleaning Tools & Stations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone33({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 33</Text>
        <Text style={styles.auditHeaderBadge}>CANTEEN / KITCHEN</Text>
      </View>
