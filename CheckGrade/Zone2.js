...
// --- ZONE 2 SPECIFIC CHECKLIST DATA ---
const ZONE_2_CHECKLIST = [
  { id: 'z2_1', title: 'Workstations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z2_2', title: 'Desktop or Laptop', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z2_3', title: 'Hard copy files', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z2_4', title: 'System files', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z2_5', title: 'Physical Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z2_6', title: 'Common items', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z2_7', title: 'Visitor Seating Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z2_8', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone2({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 2</Text>
        <Text style={styles.auditHeaderBadge}>LOWER OFFICE</Text>
      </View>
