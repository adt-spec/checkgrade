...
// --- ZONE 6 SPECIFIC CHECKLIST DATA (20 Checkpoints) ---
const ZONE_6_CHECKLIST = [
  { id: 'z6_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_3', title: 'Facilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_4', title: 'Floors & Gangways', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_5', title: 'Parts movement in Hangers', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_6', title: 'Employee Essentials', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_7', title: 'Tooling, Fixtures, Jigs', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_8', title: 'Wires, cabling & Hoses', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_9', title: 'Workbenches & surfaces', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_10', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_11', title: 'Red Tag', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_12', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_13', title: 'Material Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_14', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_15', title: 'Machine Guards, Windows & Interlocks', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_16', title: 'Hard patterns', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_17', title: 'Folder/Equipement storage area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_18', title: 'Tab', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_19', title: 'Endline Desk & QA Point', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z6_20', title: 'Idle Machines', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone6({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 6</Text>
        <Text style={styles.auditHeaderBadge}>LINE 9</Text>
      </View>
