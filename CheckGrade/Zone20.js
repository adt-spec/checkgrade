...
// --- ZONE 20 SPECIFIC CHECKLIST DATA (7 Checkpoints) ---
const ZONE_20_CHECKLIST = [
  { id: 'z20_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z20_2', title: 'Floorways & Material Movement', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z20_3', title: 'Hydraulic Movers & Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z20_4', title: 'Trims Receiving & Sorting', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z20_5', title: 'Trims Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z20_6', title: 'Waste Handling & Outdated Trims', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z20_7', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone20({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 20</Text>
        <Text style={styles.auditHeaderBadge}>TRIMS AREA 1ST FL</Text>
      </View>
