...
// --- ZONE 32 SPECIFIC CHECKLIST DATA (6 Checkpoints) ---
const ZONE_32_CHECKLIST = [
  { id: 'z32_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z32_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z32_3', title: 'Health Compliance', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z32_4', title: 'Dining Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z32_5', title: 'Waste Disposal Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z32_6', title: 'Cleaning Tools & Stations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone32({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 32</Text>
        <Text style={styles.auditHeaderBadge}>MACHAN / DINING AREA</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  auditHeader: { paddingHorizontal: 20, paddingTop: Platform.OS === 'any' ? 50 : 20, paddingBottom: 20, backgroundColor: '#FFF', borderBottomWidth: 1, borderColor: '#E5E7EB' },
