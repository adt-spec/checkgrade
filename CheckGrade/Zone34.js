...
// --- ZONE 34 SPECIFIC CHECKLIST DATA (21 Checkpoints) ---
const ZONE_34_CHECKLIST = [
  { id: 'z34_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_3', title: 'Facilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_4', title: 'Floors & Gangways', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_5', title: 'Parts movement in Hangers', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_6', title: 'Employee Essentials', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_7', title: 'Tooling, Fixtures, Jigs', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_8', title: 'Wires, cabling & Hoses', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_9', title: 'Workbenches & surfaces', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_10', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_11', title: 'Red Tag', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_12', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_13', title: 'Material Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_14', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_15', title: 'Machine Guards, Windows & Interlocks', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_16', title: 'Hard patterns', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_17', title: 'Folder/Equipement storage area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_18', title: 'Tab', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_19', title: 'Endline Desk & QA Point', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_20', title: 'Idle Machines', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z34_21', title: 'Drinking Water Station', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone34({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 34</Text>
        <Text style={styles.auditHeaderBadge}>SEWING FACTORY 5</Text>
      </View>
    ...
    <View style={styles.checklistCard}>
        ...
        <View style={styles.imageCol}>
          ...
          {actualImage ? (
            ...
            <TouchableOpacity style={styles.comparePlaceholder} onPress={takePicture}>
              ...
              <Text style={styles.placeholderTapText}>Upload Photo</Text>
            </TouchableOpacity>
          )}
        </View>
      </View>
      ...
      <View style={styles.actionRow}>
        {actualImage && !aiScore && !isAnalyzing && (
          <TouchableOpacity style={styles.aiButton} onPress={analyzeImages}><Text style={styles.aiButtonText}>Analyze Scan</Text></TouchableOpacity>
        )}
        {isAnalyzing && (
          <View style={styles.analyzingBox}><ActivityIndicator size="small" color="#6366F1" /><Text style={styles.analyzingText}>Checking 5S...</Text></View>
        )}
        {aiScore && (
          <View style={styles.scoreResult}><Text style={styles.scoreResultLabel}>AI Score:</Text><Text style={styles.scoreResultValue}>{aiScore}/5</Text></View>
        )}
      </View>
    </View>
  );
