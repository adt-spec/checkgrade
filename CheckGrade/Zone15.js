...
// --- ZONE 15 SPECIFIC CHECKLIST DATA (21 Checkpoints) ---
const ZONE_15_CHECKLIST = [
  { id: 'z15_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_3', title: 'Facilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_4', title: 'Floors & Gangways', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_5', title: 'Parts movement in Hangers', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_6', title: 'Employee Essentials', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_7', title: 'Workbenches & surfaces', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_8', title: 'Wires, cabling & Hoses', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_9', title: 'Ironing Stations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_10', title: 'Interlay Insertion', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_11', title: 'Body Press', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_12', title: 'Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_13', title: 'Packing Tables', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_14', title: 'Stain Removal Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_15', title: 'Dusting Area & Thread Suction', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_16', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_17', title: 'Red Tag', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_18', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_19', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_20', title: 'Tab', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z15_21', title: 'In line idle machine', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone15({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 15</Text>
        <Text style={styles.auditHeaderBadge}>FINISHING FACTORY 1</Text>
      </View>
