...
// --- ZONE 30 SPECIFIC CHECKLIST DATA (7 Checkpoints) ---
const ZONE_30_CHECKLIST = [
  { id: 'z30_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z30_2', title: 'Floorways & Material Movement', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z30_3', title: 'Hydraulic Movers & Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z30_4', title: 'Trims Receiving & Sorting', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z30_5', title: 'Trims Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z30_6', title: 'Waste Handling & Outdated Trims', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z30_7', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone30({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 30</Text>
        <Text style={styles.auditHeaderBadge}>TRIMS AREA 2ND FL</Text>
      </View>
