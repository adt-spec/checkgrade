...
// --- ZONE 12 SPECIFIC CHECKLIST DATA (8 Checkpoints) ---
const ZONE_12_CHECKLIST = [
  { id: 'z12_1', title: 'Workstations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z12_2', title: 'Desktop or Laptop', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z12_3', title: 'Hard copy files', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z12_4', title: 'System files', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z12_5', title: 'Physical Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z12_6', title: 'Common items', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z12_7', title: 'Pantry area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z12_8', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone12({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 12</Text>
        <Text style={styles.auditHeaderBadge}>UPPER OFFICE</Text>
      </View>
