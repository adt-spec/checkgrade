...
// --- ZONE 31 SPECIFIC CHECKLIST DATA (6 Checkpoints) ---
const ZONE_31_CHECKLIST = [
  { id: 'z31_1', title: 'Samples', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z31_2', title: 'QA Files & Reports Section', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z31_3', title: 'Workstations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z31_4', title: 'Cupboards & Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z31_5', title: 'Employee Essentials & Common Items', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z31_6', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone31({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 31</Text>
        <Text style={styles.auditHeaderBadge}>CSO 2ND FLOOR</Text>
      </View>
