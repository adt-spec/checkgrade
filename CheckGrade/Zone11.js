...
// --- ZONE 11 SPECIFIC CHECKLIST DATA (4 Checkpoints) ---
const ZONE_11_CHECKLIST = [
  { id: 'z11_1', title: 'Truck Movement', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z11_2', title: 'External Surroundings', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z11_3', title: 'Gardening Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z11_4', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone11({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 11</Text>
        <Text style={styles.auditHeaderBadge}>BACKSIDE</Text>
      </View>
