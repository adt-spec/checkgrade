...
// --- ZONE 8 SPECIFIC CHECKLIST DATA (10 Checkpoints) ---
const ZONE_8_CHECKLIST = [
  { id: 'z8_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_2', title: 'Workstations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_3', title: 'Desktop or Laptop', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_4', title: 'Hard copy files', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_5', title: 'System files', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_6', title: 'Filing Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_7', title: 'Sample Storage Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_8', title: 'Common Items & Utilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_9', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z8_10', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone8({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 8</Text>
        <Text style={styles.auditHeaderBadge}>PRE PRODUCTION ROOM</Text>
      </View>
