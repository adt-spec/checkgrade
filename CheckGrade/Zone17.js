...
// --- ZONE 17 SPECIFIC CHECKLIST DATA (7 Checkpoints) ---
const ZONE_17_CHECKLIST = [
  { id: 'z17_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z17_2', title: 'Packing Workstation', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z17_3', title: 'Tag Placement & Accessories Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z17_4', title: 'Size-wise Segregation', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z17_5', title: 'Carton Placement (Non-CTPAT)', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z17_6', title: 'Conveyor Transfer Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z17_7', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone17({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 17</Text>
        <Text style={styles.auditHeaderBadge}>BAGGING AREA 1ST FL</Text>
      </View>
