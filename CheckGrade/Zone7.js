...
// --- ZONE 7 SPECIFIC CHECKLIST DATA (11 Checkpoints) ---
const ZONE_7_CHECKLIST = [
  { id: 'z7_1', title: 'Workstations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_2', title: 'Desktop', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_3', title: 'Hard copy files', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_4', title: 'Digital Files & CAD Data', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_5', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_6', title: 'CAD Printer & Plotter Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_7', title: 'Marker Storage Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_8', title: 'Ready Pattern Issue Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_9', title: 'Size Set Samples', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_10', title: 'Common items', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z7_11', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone7({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 7</Text>
        <Text style={styles.auditHeaderBadge}>CAD</Text>
      </View>
