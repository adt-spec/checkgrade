...
// --- ZONE 27 SPECIFIC CHECKLIST DATA (7 Checkpoints) ---
const ZONE_27_CHECKLIST = [
  { id: 'z27_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z27_2', title: 'Packing Workstation', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z27_3', title: 'Tag Placement & Accessories Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z27_4', title: 'Size-wise Segregation', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z27_5', title: 'Carton Placement (Non-CTPAT)', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z27_6', title: 'Conveyor Transfer Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z27_7', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone27({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 27</Text>
        <Text style={styles.auditHeaderBadge}>BAGGING AREA 2ND FL</Text>
      </View>
