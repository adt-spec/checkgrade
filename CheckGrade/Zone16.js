...
// --- ZONE 16 SPECIFIC CHECKLIST DATA (22 Checkpoints) ---
const ZONE_16_CHECKLIST = [
  { id: 'z16_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_3', title: 'Drinking Water Station', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_4', title: 'Facilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_5', title: 'Floors & Gangways', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_6', title: 'Parts movement in Hangers', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_7', title: 'Employee Essentials', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_8', title: 'Workbenches & surfaces', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_9', title: 'Wires, cabling & Hoses', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_10', title: 'Ironing Stations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_11', title: 'Interlay Insertion', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_12', title: 'Body Press', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_13', title: 'Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_14', title: 'Packing Tables', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_15', title: 'Stain Removal Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_16', title: 'Dusting Area & Thread Suction', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_17', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_18', title: 'Red Tag', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_19', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_20', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_21', title: 'Tab', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z16_22', title: 'In line idle machine', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone16({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 16</Text>
        <Text style={styles.auditHeaderBadge}>FINISHING FACTORY 2</Text>
      </View>
