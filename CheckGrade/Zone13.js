...
// --- ZONE 13 SPECIFIC CHECKLIST DATA (21 Checkpoints) ---
const ZONE_13_CHECKLIST = [
  { id: 'z13_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_3', title: 'Drinking Water Station', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_4', title: 'Facilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_5', title: 'Floors & Gangways', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_6', title: 'Parts movement in Hangers', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_7', title: 'Employee Essentials', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_8', title: 'Tooling, Fixtures, Jigs', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_9', title: 'Wires, cabling & Hoses', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_10', title: 'Workbenches & surfaces', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_11', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_12', title: 'Red Tag', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_13', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_14', title: 'Material Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_15', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_16', title: 'Machine Guards, Windows & Interlocks', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_17', title: 'Hard patterns', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_18', title: 'Folder/Equipement storage area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_19', title: 'Tab', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_20', title: 'Endline Desk & QA Point', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z13_21', title: 'Idle Machines', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone13({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 13</Text>
        <Text style={styles.auditHeaderBadge}>SEWING FACTORY 1</Text>
      </View>
