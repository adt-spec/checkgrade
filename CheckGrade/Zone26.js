...
// --- ZONE 26 SPECIFIC CHECKLIST DATA (22 Checkpoints) ---
const ZONE_26_CHECKLIST = [
  { id: 'z26_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_3', title: 'Drinking Water Station', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_4', title: 'Facilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_5', title: 'Floors & Gangways', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_6', title: 'Parts movement in Hangers', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_7', title: 'Employee Essentials', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_8', title: 'Workbenches & surfaces', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_9', title: 'Wires, cabling & Hoses', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_10', title: 'Ironing Stations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_11', title: 'Interlay Insertion', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_12', title: 'Body Press', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_13', title: 'Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_14', title: 'Packing Tables', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_15', title: 'Stain Removal Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_16', title: 'Dusting Area & Thread Suction', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_17', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_18', title: 'Red Tag', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_19', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_20', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_21', title: 'Tab', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z26_22', title: 'In line idle machine', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone26({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 26</Text>
        <Text style={styles.auditHeaderBadge}>FINISHING FACTORY 4</Text>
      </View>
