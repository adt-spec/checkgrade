...
const ZONE_9_CHECKLIST = [
  { id: 'z9_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_2', title: 'Workstations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_3', title: 'Drinking Water Station', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_4', title: 'Fabric & Trims Unloading Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_5', title: 'Floor Paths', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_6', title: 'Fabric Inspection & Quality Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_7', title: 'Hydraulic Movers, Forklifts', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_8', title: 'Vertical Conveyor & Material Movement', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_9', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_10', title: 'Pallet Condition & Rack Placement', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_11', title: 'Bin Cards & Inventory Marking', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z9_12', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone9({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 9</Text>
        <Text style={styles.auditHeaderBadge}>WAREHOUSE</Text>
      </View>
