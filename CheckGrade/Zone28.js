...
// --- ZONE 28 SPECIFIC CHECKLIST DATA (5 Checkpoints) ---
const ZONE_28_CHECKLIST = [
  { id: 'z28_1', title: 'Button Removing & Buyer-Wise Sorting', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z28_2', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z28_3', title: 'Button, Thread & Tool Placement', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z28_4', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z28_5', title: 'Idle Machines', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone28({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 28</Text>
        <Text style={styles.auditHeaderBadge}>RE-BUTTONING AREA</Text>
      </View>
