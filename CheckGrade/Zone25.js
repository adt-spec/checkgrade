...
// --- ZONE 25 SPECIFIC CHECKLIST DATA (21 Checkpoints) ---
const ZONE_25_CHECKLIST = [
  { id: 'z25_1', title: 'Health & Safety', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_2', title: 'Environmental', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_3', title: 'Facilities', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_4', title: 'Floors & Gangways', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_5', title: 'Parts movement in Hangers', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_6', title: 'Employee Essentials', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_7', title: 'Workbenches & surfaces', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_8', title: 'Wires, cabling & Hoses', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_9', title: 'Ironing Stations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_10', title: 'Interlay Insertion', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_11', title: 'Body Press', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_12', title: 'Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_13', title: 'Packing Tables', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_14', title: 'Stain Removal Area', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_15', title: 'Dusting Area & Thread Suction', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_16', title: 'Visual & Digital Tracking Boards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_17', title: 'Red Tag', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_18', title: 'Mobile Equipment', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_19', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_20', title: 'Tab', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z25_21', title: 'In line idle machine', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone25({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 25</Text>
        <Text style={styles.auditHeaderBadge}>FINISHING FACTORY 3</Text>
      </View>
