...
// --- ZONE 21 SPECIFIC CHECKLIST DATA (6 Checkpoints) ---
const ZONE_21_CHECKLIST = [
  { id: 'z21_1', title: 'Samples', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z21_2', title: 'QA Files & Reports Section', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z21_3', title: 'Workstations', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z21_4', title: 'Cupboards & Storage', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z21_5', title: 'Employee Essentials & Common Items', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
  { id: 'z21_6', title: 'Cleaning Standards', standardImg: require('../assets/Zone1_Cleaning.jpeg') },
];

export default function Zone21({ goBack }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.auditHeader}>
        ...
        <Text style={styles.auditHeaderTitle}>Zone 21</Text>
        <Text style={styles.auditHeaderBadge}>CSO 1ST FLOOR</Text>
      </View>
