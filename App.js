...
const ZONES = [
  ...
  { id: '3', name: 'Zone 3', badge: 'CRÈCHE / MEDICAL', image: require('./assets/Zone 3.png') },
  { id: '4', name: 'Zone 4', badge: 'PREPATORY AREA', image: require('./assets/Zone 4.png') },
  { id: '5', name: 'Zone 5', badge: 'CUTTING', image: require('./assets/Zone 5.jpg') },
  { id: '6', name: 'Zone 6', badge: 'LINE 9', image: require('./assets/Zone 6.jpg') },
  { id: '7', name: 'Zone 7', badge: 'CAD', image: require('./assets/Zone 7.jpeg') },
  { id: '8', name: 'Zone 8', badge: 'PRE PRODUCTION', image: require('./assets/Zone1_Cleaning.jpeg') },
  { id: '9', name: 'Zone 9', badge: 'WAREHOUSE', image: require('./assets/Zone 9.jpeg') },
  { id: '10', name: 'Zone 10', badge: 'UTILITY AREA', image: require('./assets/Zone1_Cleaning.jpeg') },
  { id: '11', name: 'Zone 11', badge: 'BACKSIDE AREA', image: require('./assets/Zone 11.jpeg') },
  { id: '12', name: 'Zone 12', badge: 'UPPER OFFICE', image: require('./assets/Zone1_Cleaning.jpeg') },
  { id: '13', name: 'Zone 13', badge: 'SEWING FACTORY 1', image: require('./assets/Zone 13.jpg') },
  { id: '14', name: 'Zone 14', badge: 'SEWING FACTORY 2', image: require('./assets/Zone 14.jpg') },
  { id: '15', name: 'Zone 15', badge: 'FINISHING FACTORY 1', image: require('./assets/Zone 15.jpg') },
  { id: '16', name: 'Zone 16', badge: 'FINISHING FACTORY 2', image: require('./assets/Zone 16.jpg') },
  { id: '17', name: 'Zone 17', badge: 'BAGGING 1ST FL', image: require('./assets/Zone 17.jpg') },
  { id: '18', name: 'Zone 18', badge: 'MAINTENANCE', image: require('./assets/Zone 18.jpeg') },
  { id: '19', name: 'Zone 19', badge: 'FG WAREHOUSE 1ST FL', image: require('./assets/Zone 19.jpeg') },
  { id: '20', name: 'Zone 20', badge: 'TRIMS AREA 1ST FL', image: require('./assets/Zone 20.jpeg') },
  { id: '21', name: 'Zone 21', badge: 'CSO 1ST FLOOR', image: require('./assets/Zone1_Cleaning.jpeg') },
  { id: '22', name: 'Zone 22', badge: 'TRAINING', image: require('./assets/Zone 22.jpeg') },
  { id: '23', name: 'Zone 23', badge: 'SEWING FACTORY 3', image: require('./assets/Zone 23.jpg') },
  { id: '24', name: 'Zone 24', badge: 'SEWING FACTORY 4', image: require('./assets/Zone 24.jpg') },
  { id: '25', name: 'Zone 25', badge: 'FINISHING FACTORY 3', image: require('./assets/Zone 25.jpg') },
  { id: '26', name: 'Zone 26', badge: 'FINISHING FACTORY 4', image: require('./assets/Zone 26.jpg') },
  { id: '27', name: 'Zone 27', badge: 'BAGGING 2ND FL', image: require('./assets/Zone 27.jpg') },
  { id: '28', name: 'Zone 28', badge: 'RE-BUTTONING', image: require('./assets/Zone1_Cleaning.jpeg') },
  { id: '29', name: 'Zone 29', badge: 'FG WAREHOUSE 2ND FL', image: require('./assets/Zone 29.jpeg') },
  { id: '30', name: 'Zone 30', badge: 'TRIMS AREA 2ND FL', image: require('./assets/Zone 30.jpeg') },
  { id: '31', name: 'Zone 31', badge: 'CSO 2ND FLOOR', image: require('./assets/Zone1_Cleaning.jpeg') },
  { id: '32', name: 'Zone 32', badge: 'MACHAN', image: require('./assets/Zone 32.jpeg') },
  { id: '33', name: 'Zone 33', badge: 'CANTEEN', image: require('./assets/Zone 33.jpeg') },
  { id: '34', name: 'Zone 34', badge: 'SEWING FACTORY 5', image: require('./assets/Zone 34.jpg') },
  { id: '35', name: 'Zone 35', badge: 'FINISHING FACTORY 5', image: require('./assets/Zone 35.jpg') },
];
